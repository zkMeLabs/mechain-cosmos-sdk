...
func (m *MockCrossChainKeeper) GetReceiveSequence(ctx types.Context, destChainId types.ChainID, channelID types.ChannelID) uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReceiveSequence", ctx, destChainId, channelID)
	ret0, _ := ret[0].(uint64)
	return ret0
}

// GetReceiveSequence indicates an expected call of GetReceiveSequence.
func (mr *MockCrossChainKeeperMockRecorder) GetReceiveSequence(ctx, destChainId, channelID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReceiveSequence", reflect.TypeOf((*MockCrossChainKeeper)(nil).GetReceiveSequence), ctx, destChainId, channelID)
}

// GetSendSequence mocks base method.
func (m *MockCrossChainKeeper) GetSendSequence(ctx types.Context, destChainId types.ChainID, channelID types.ChannelID) uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSendSequence", ctx, destChainId, channelID)
	ret0, _ := ret[0].(uint64)
	return ret0
}

// GetSendSequence indicates an expected call of GetSendSequence.
func (mr *MockCrossChainKeeperMockRecorder) GetSendSequence(ctx, destChainId, channelID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSendSequence", reflect.TypeOf((*MockCrossChainKeeper)(nil).GetSendSequence), ctx, destChainId, channelID)
}
